...
final class VersionSpec
{
    ...
    public static function products(): array
    {
        return [
            ...
            'phalcon' => ['label' => 'aPhalcon', 'env' => 'APHALCON_VERSION', 'kind' => 'composer', 'stacks' => ['evo-phalcon'], 'source' => 'https://github.com/elcreator/aPhalcon', 'package' => 'elcreator/aphalcon', 'aliases' => ['aphalcon']],
