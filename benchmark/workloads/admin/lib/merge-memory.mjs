...
const [reportPath, summaryPath, containerPeak] = process.argv.slice(2);
...
const merged = mergePhpMemory(report, summary, containerPeak ? Number.parseFloat(containerPeak) : undefined);
